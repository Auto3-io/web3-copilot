...
user_content = '''
1. Swap 0.01 ETH for USDC using Uniswap on Ethereum:
...
openai.ChatCompletion.create(
    model="gpt-3.5-turbo",
    messages=[
        {"role": "system", "content": "Create a Python program that performs on-chain operations with sub-functions and main functions: "},
        {"role": "user", "content":  user_content},
    ],
    temperature = 0,
    pl_tags=["program_swap_ETHUSDC"]
)
